...
<body>
	<body>
	<a href="venueadmin.php" class="top"><img src="download.png" width="40" height="40" class="logo">
...
// Make the query
$q = "DELETE FROM venue WHERE did=$id ";
...
$q = "SELECT venueid FROM venue WHERE did=$id";
$result = @mysqli_query ($dbcon , $q);
