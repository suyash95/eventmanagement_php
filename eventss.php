...
<meta charset=utf-8>
<link rel="stylesheet" type="text/css" href="eventss.css">
...
$q = "SELECT event_id AS event_id,type AS type ,type2 AS type2, title AS title, summary AS summary   FROM eventdetails";
