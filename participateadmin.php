...
<meta charset=utf-8><link rel="stylesheet" type="text/css" href="participateadmin22.css">
...
$q = "SELECT did, firstname AS firstname ,lastname AS lastname, email_id AS email_id, USNno AS USNno,
conatct_no AS conatct_no  FROM participants";
...
if ($result) { // If it ran OK, display the records
                ...
                <td><a href="delete.php?id=' . $row['did'] . '">Delete</a></td></tr>'; }
