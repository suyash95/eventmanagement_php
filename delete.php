...
<body>
	<body>
	<a href="participateadmin.php" class="top"><img src="download1.jpg" width="40" height="40" class="logo">
...
// Make the query
$q = "DELETE FROM participants WHERE did=$id ";
...
$q = "SELECT did FROM participants WHERE did=$id";
$result = @mysqli_query ($dbcon , $q);
