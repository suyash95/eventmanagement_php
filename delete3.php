...
<body>
	<body>
	<a href="useradmin.php" class="top"><img src="download1.jpg" width="40" height="40" class="logo">
...
<?php
// Check for a valid user ID, through GET.php or POST
...
// Make the query
$q = "DELETE FROM userdetails WHERE faculty_ID=$id ";
...
$q = "SELECT firstname FROM userdetails WHERE faculty_ID=$id";
$result = @mysqli_query ($dbcon , $q);
